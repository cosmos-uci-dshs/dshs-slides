---
title: "Welcome"
author: "Dr. Babak Shahbaba <br> Dr. Sam Behseta"
output: 
...
knitr::include_graphics("img/Babak.jpeg")
```
...
```{r echo=FALSE, fig.align='center', out.width="30%"}
knitr::include_graphics("img/Behseta.png")
```
...
```{r echo=FALSE, fig.align='center', out.width="30%"}
knitr::include_graphics("img/Brian.jpg")
```
...
```{r echo=FALSE, fig.align='center', out.width="30%"}
knitr::include_graphics("img/Zahra.JPG")
```
...
| Week 2      |Probability, Inference, and Statistical Modeling
...
```{r echo=FALSE, out.width="30%"}
knitr::include_graphics("img/thephysicsgirl.png")
```
