---
title: "Samples, Statistics and their Distributions"
author: 
  - "Dr. Uma Ravat 
...
knitr::include_graphics('./img/pic-pop_sample.png')
```
...
.pull-left[
```{r, echo=FALSE,out.width='80%',fig.align='center'}
knitr::include_graphics('./img/pic-sample-1.png')
```
...
```{r, echo=FALSE,out.width='80%',fig.align='center'}
knitr::include_graphics('./img/pic-sample-2.png')
```

```{r, echo=FALSE,out.width='80%',fig.align='center'}
knitr::include_graphics('./img/pic-sample-3.png')
```
...
.row[
and look at the proportion of orange candy in these samples?
]
...
<img src="./img/visualizationOfsamplingdistn.png" width="500" height="450">
...
.pull-left[
<img src="./img/Quantifying_sampling_variability.png" width="500" height="450">
]
...
.pull-left[
### The value of the proportion of orange candy
...
<img src="./img/clt_prop_grid_1.png" width="500" height="550">
<img src="./img/clt_prop_grid_2.png" width="500" height="550">
...
.footnote[`*` CLT holds if if np and n(1-p) are large (10 or more)]
...
knitr::include_graphics('./img/clt_prop_example.png')
```
