...
- Similar to linear regression models, we specify the model formula by entering the response variable on the left side of the "~" symbol and the explanatory (predictor) variables (separated by "+" sings) on the right side. 
